...
public class Assassi extends Personatge implements Ordre, Caos {

    public Assassi(String nom, String classe, int str, int con, int vel,
    ...
    //Calcula les estadistiques derivades
